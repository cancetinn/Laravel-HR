                    ...
                    <div class="card mb-6">
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-6 pb-4 border-bottom justify-content-center">
                                <img src="{{ $user->profile_image_url }}" alt="users" class="d-block w-px-200 h-px-200 rounded" id="uploadedAvatar" />
                            </div>
                        </div>
                            ...
                            <form id="formAccountSettings" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                                ...
                                <div class="row g-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="date" name="joining_date" value="{{ $user->joining_date }}" id="joining_date">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="password_confirmation" class="form-label">Tekrar Yeni Şifre</label>
